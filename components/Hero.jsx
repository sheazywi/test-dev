...
const Hero = () => {
  return (
    <section className="relative w-full h-full mx-auto bg-black" id="hero">
      <div className={`${styles.paddingX} absolute justify-center inset-0 top-[120px] max-w-7xl sm:max-w-4xl mx-auto flex flex-row items-start gap-5`}>
